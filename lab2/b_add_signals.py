...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentTextChanged.connect(self.onComboBoxCurrentTextChanged) # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        self.spinBox.textChanged.connect(self.onSpinBoxCurrentTextChanged)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
    ...
    def onSpinBoxCurrentTextChanged(self) -> None:
        self.plainTextEditLog.setPlainText(self.spinBox.text())
